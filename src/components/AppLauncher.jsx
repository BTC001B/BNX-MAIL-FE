  ...
  return (
    <div className="flex flex-col h-full bg-white w-full select-none">
      ...
      <div className="flex-1 overflow-y-auto hidden-scrollbar px-6 py-2 flex flex-col justify-between" style={{ maxHeight: 'calc(100vh - 100px)' }}>
        ...
        <div className="border border-gray-200/90 rounded-[20px] p-4 mt-2 mb-0.5 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.01)]">
          ...
          <div className="border-b border-gray-100 mb-3 -mx-4" />
