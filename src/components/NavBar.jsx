      ...
      <div className="flex items-center justify-between w-full relative">
        ...
        <div className="flex items-center justify-end gap-1 sm:gap-3 md:flex-1 shrink-0">
          ...
          <button
            ...
            className="h-9 p-1 px-2 rounded-full bg-white dark:hover:bg-white/10 transition-colors flex items-center justify-center shrink-0 border border-transparent hover:border-gray-200 dark:hover:border-gray-700 ml-2 sm:ml-4"
